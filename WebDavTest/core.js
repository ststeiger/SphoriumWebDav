...
{
	var L_NoWSSClient_Text="To export a list, you must have a Windows WebDAV Services-compatible application and Microsoft Internet Explorer 6.0 or greater.";
	var L_ExportDBFail_Text="Export to database failed. To export a list, you must have a Windows WebDAV Services-compatible application.";
...
{
	var L_ExportListSpreadsheet_Text="To export a list, you must have a Windows WebDAV Services-compatible application.";
...
var fNewDoc2=false;
var fNewDoc3=false;
var L_EditDocumentProgIDError_Text="'Edit Document' requires a Windows WebDAV Services-compatible application and Microsoft Internet Explorer 6.0 or greater.";
var L_EditDocumentRuntimeError_Text="The document could not be opened for editing.  A Windows WebDAV Services compatible application could not be found to edit the document.";
...
var L_OpenDocumentLocalError_Text="This document was being edited offline, but there is no application configured to open the document from WebDAV.  The document can only be opened for reading.";
...
{
	var L_IE5upRequired_Text="'Discuss' requires a Windows WebDAV Services-compatible application and Microsoft Internet Explorer 6.0 or greater.";
	if (browseris.ie5up && browseris.win32)
